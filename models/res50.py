...
class ResNet(nn.Module):
    ...
    def __init__(self, layers: List[int], num_classess=1000):
        ...
        self.conv0 = nn.Conv2d(4, 3, kernel_size=3,
        ...
        self.conv_out = nn.Conv2d(512, 256, kernel_size=3,
    ...
    def forward(self, x):
        ...
        out = self.maxpool(self.relu(self.bn1(self.conv1(self.conv0(x)))))
        print(out.shape)
        # Stage 2-5
        out = self.layer1(out)
        out = self.layer2(out)
...
if __name__ == '__main__':
    ...
    resnet50 = ResNet.ResNet50(num_classess)
    ...
    state_dict['conv0.weight'] = torch.randn([3,4,3,3])
    state_dict['conv0.bias'] = torch.randn([3])
    state_dict['conv_out.weight'] = torch.randn([256, 512, 3, 3])
